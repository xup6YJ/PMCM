...
def net_factory(net_type="unet", in_chns=1, class_num=4, mode="train", args = None):
    if net_type == "vnet" and mode == "train":
        ...
        net = Mine3d_v1(args, n_channels=in_chns, n_classes=class_num, normalization='batchnorm', has_dropout=True).cuda()
        ...
        net = Mine3d_v1(args, n_channels=in_chns, n_classes=class_num, normalization='batchnorm', has_dropout=False).cuda()
